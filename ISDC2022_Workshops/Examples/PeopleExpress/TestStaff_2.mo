...
model TestStaff_2 "6 planes => hiring until staff = 360; 0 RPM => service quality = 1.0"
  ...
  BusinessSimulation.Converters.ConstantConverterRate revenuePassengerMiles(timeBaseString = "year", value(displayUnit = "billion") = 0) "Revenue passenger miles per period" annotation(Placement(visible = true, transformation(origin = {-80, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  BusinessSimulation.Converters.ConstantConverter fleetsize(value = 6) "Aircraft in the fleed" annotation(Placement(visible = true, transformation(origin = {-80, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
