...
model TeaCupComponentBased1S "Component-based version of the tea cup model (unidirectional sink)"
  ...
  BusinessSimulation.Stocks.MaterialStock tempCup(redeclare replaceable type OutputType = BusinessSimulation.Types.Reals(unit = "degC"), initialValue = 90) "Temperature of tea in a cup" annotation(Placement(visible = true, transformation(origin = {0, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  BusinessSimulation.SourcesOrSinks.Decline losingHeat "Heatflow from the cup" annotation(Placement(visible = true, transformation(origin = {40, -20}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
equation
