...
</html>"), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Text(visible = true, origin = {0, 20}, textColor = {255, 255, 255}, extent = {{-87.106, -30}, {87.106, 30}}, textString = "ISDC", fontName = "Lato Black", textStyle = {TextStyle.Bold}), Text(visible = true, origin = {0, -30}, textColor = {255, 255, 255}, extent = {{-87.106, -20}, {87.106, 25}}, textString = "2022", fontName = "Lato Black", textStyle = {TextStyle.Bold})}));
